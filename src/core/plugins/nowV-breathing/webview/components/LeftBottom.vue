<template>
    <div class="cc">
    <div class="creator">
        <a href="https://github.com/lucafont2/dbd-skillcheck-simulator" target="_blank"><img src="../assets/icons/lucaservers.png"  alt=""></a><br>
      <a href="https://github.com/trekkspace/dbd-skillcheck-simulator" target="_blank"><img src="../assets/icons/trekkspace.png"  alt=""></a>
    </div> 
    <!-- // fullscreen button -->
