<template>
    <div>
        <div>
            <div class="menu" v-if="menu">
                <div class="navigation">
                    ...
                    <div class="navigation-items">
                        <a
                            @click.prevent="center = 'PlayerSettings'"
                            :class="center == 'PlayerSettings' ? 'simple-to' : 'navigation-to'"
                            href=""
                            >Settings</a
                        >
                        <a
                            @click.prevent="center = 'GameMode'"
                            :class="center == 'GameMode' ? 'simple-to' : 'navigation-to'"
                            href=""
                            >Game Mode</a
                        >
                        <a
                            @click.prevent="center = 'PlayerScore'"
                            :class="center == 'PlayerScore' ? 'simple-to' : 'navigation-to'"
                            href=""
                            >Stats</a
                        >
                        <a
                            @click.prevent="center = 'GameStore'"
                            :class="center == 'GameStore' ? 'simple-to' : 'navigation-to'"
                            href=""
                            >Shop</a
                        >
                        <a
                            @click.prevent="center = 'PlayerInventory'"
                            :class="center == 'PlayerInventory' ? 'simple-to' : 'navigation-to'"
                            href=""
                            >Inventory</a
                        >
                        <a
                            @click.prevent="center = 'About'"
                            :class="center == 'About' ? 'simple-to' : 'navigation-to'"
                            href=""
                            >About</a
                        >
                    </div>
            ...
            <div v-if="firstOpen" class="tip">
                <span>TIP: Open the MENU > Game Mode to customize the skillcheck</span>
            </div>
        </div>
    </div>
</template>
